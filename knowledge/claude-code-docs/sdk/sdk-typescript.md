...
| --- | --- | --- |
| `prompt` | `string | AsyncIterable<`[`SDKUserMessage`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#sdkuser-message)`>` | The input prompt as a string or async iterable for streaming mode |
...
Returns a [`Query`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#query-object) object that extends `AsyncGenerator<`[`SDKMessage`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#sdk-message)`, void>` with additional methods.
...
Returns a `Promise<`[`WarmQuery`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#warm-query)`>` that resolves once the subprocess has spawned and completed its initialize handshake.
...
| `handler` | `(args, extra) => Promise<`[`CallToolResult`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#call-tool-result)`>` | Async function that executes the tool logic |
| `extras` | `{ annotations?:`[`ToolAnnotations`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#tool-annotations)`}` | Optional MCP tool annotations providing behavioral hints to clients |
...
| `tag` | `string | undefined` | User-set session tag (see [`tagSession()`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#tag-session)) |
...
Returns [`SDKSessionInfo`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#return-type-sdk-session-info), or `undefined` if the session is not found.
...
| `betas` | [`SdkBeta`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#sdk-beta)`[]` | `[]` | Enable beta features |
| `canUseTool` | [`CanUseTool`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#can-use-tool) | `undefined` | Custom permission function for tool usage |
...
| `hooks` | `Partial<Record<`[`HookEvent`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#hook-event)`,`[`HookCallbackMatcher`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#hook-callback-matcher)`[]>>` | `{}` | Hook callbacks for events |
...
| `permissionMode` | [`PermissionMode`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#permission-mode) | `'default'` | Permission mode for the session |
...
| `plugins` | [`SdkPluginConfig`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#sdk-plugin-config)`[]` | `[]` | Load custom plugins from local paths. See [Plugins](https://code.claude.com/docs/en/agent-sdk/plugins) for details |
...
| `sandbox` | [`SandboxSettings`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#sandbox-settings) | `undefined` | Configure sandbox behavior programmatically. See [Sandbox settings](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#sandbox-settings) for details |
...
| `thinking` | [`ThinkingConfig`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#thinking-config) | `{ type: 'adaptive' }` for supported models | Controls Claude’s thinking/reasoning behavior. See [`ThinkingConfig`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#thinking-config) for options |
| `toolConfig` | [`ToolConfig`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#tool-config) | `undefined` | Configuration for built-in tool behavior. See [`ToolConfig`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#tool-config) for details |
...
| `supportedAgents()` | Returns available subagents as [`AgentInfo`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#agent-info)`[]` |
...
| `permissionMode` | No | Permission mode for tool execution within this agent. See [`PermissionMode`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#permission-mode) |
...
| `suggestions` | [`PermissionUpdate`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#permission-update)`[]` | Suggested permission updates so the user is not prompted again for this tool |
...
See [`McpServerConfig`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#mcp-server-config) for details on each transport type.
...
| `network` | [`SandboxNetworkConfig`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#sandbox-network-config) | `undefined` | Network-specific sandbox configuration |
| `filesystem` | [`SandboxFilesystemConfig`](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#sandbox-filesystem-config) | `undefined` | Filesystem-specific sandbox configuration for read/write restrictions |
